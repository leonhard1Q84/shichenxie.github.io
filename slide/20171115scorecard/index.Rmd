...
train_woe <- woebin_ply(
  train, bins_adj, print_step=0L)
test_woe <- woebin_ply(
  test, bins_adj, print_step=0L)
...
.pull-left[
```{r gradient_descent, echo=FALSE, fig.height=2, fig.width=4}
library(ggplot2)
...
```{r perf_pic, fig.width=9, fig.height=6}
...
rbindlist(card, fill = TRUE)[1:3,1:4]
```
